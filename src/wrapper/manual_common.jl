# Functions and constant variables defined in this file are not generated by Clang.jl automatically
...
mutable struct lms_stream_t
    ...
    lms_stream_t() = new() # allow to create an incomplete object
end
